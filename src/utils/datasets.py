...
def load_hotpotqa(setting: str = "distractor"):
    if setting == "distractor":
        file_path = os.getenv("HOTPOTQA_DEV_DISTRACTOR")
    else:
        file_path = os.getenv("HOTPOTQA_DEV_FULLWIKI")
...
def hotpotqa_fp(setting: str = "distractor"):
    if setting == "distractor":
        return os.getenv("HOTPOTQA_DEV_DISTRACTOR")
    else:
        return os.getenv("HOTPOTQA_DEV_FULLWIKI")
